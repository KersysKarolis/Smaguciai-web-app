...
opt.value = `${t.section}|${pos}`;
opt.textContent = `${t.section} - pozicija ${pos}`;
...
const [section, position] = select.value.split("|");
console.log("Section:", section);
console.log("Position:", position);
fetch(`/admin/content/getImage?section=${section}&position=${position}`)
.then(res=> {
